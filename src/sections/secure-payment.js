...
const data = {
  subTitle: 'Худалдан авах',
  title: 'Та өөрт таалагдсан хичээлээ хялбараар хамгийн хямдаар авах боломжтой',
  description:
    'Өөрт хэрэгцээт хичээлээ ердөө нэгхэн товч дараад худалдан авч үзээрэй .',
